...
namespace FoodShop.Admin
{
    public partial class Category : System.Web.UI.Page
    {
        ...
        protected void btnAddOrUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                if (Utils.IsValidExtension(fuCategoryImage.FileName)) // Fixed missing parenthesis
                {
        ...
        protected void rCategory_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            if (e.CommandName == "edit")
            {
                ...
                cmd.Parameters.AddWithValue("@CategoryId", e.CommandArgument); // Fixed typo: 'Paremeters' to 'Parameters'
                cmd.CommandType = CommandType.StoredProcedure;
                sda = new SqlDataAdapter(cmd);
                dt = new DataTable();
                sda.Fill(dt);
        ...
        protected void rCategory_ItemBound(object sender, RepeaterItemEventArgs e)
        {
