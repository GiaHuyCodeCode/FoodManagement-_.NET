<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="FoodShop.Admin.Users" %>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CssClass="badge bg-danger"
                                                                    ...
                                                                    OnClientClick="return confirm('Do yo want to delete this user?')">
                                                                    <i class="ti-trash  "></i>
                                                                </asp:LinkButton>
                                                            </td>
                                                        </tr>
