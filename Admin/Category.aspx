<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="FoodShop.Admin.Category" %>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="txtName" runat="server" CssClass="form-control"
                                                            placehodler="Enter Category Name" required>
                                                        </asp:TextBox>
                                                        <asp:HiddenField ID="hdnID" runat="server" Value="0" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Catergory Image</label>
                                                    <div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CssClass="badge bg-danger"
                                                                        ...
                                                                        OnClientClick="return confirm('Do yo want to delete this category?')">
                                                                        <i class="ti-trash  "></i>
                                                                    </asp:LinkButton>
                                                                </td>
                                                            </tr>
